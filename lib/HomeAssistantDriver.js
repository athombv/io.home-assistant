            ...
            if (entityId.startsWith('media_player.')) {
              ...
              if (entity.instance.attributes) {
                if (typeof entity.instance.state === 'string') {
                  ...
                  homeyDevice.capabilitiesOptions['speaker_playing'].title = entity.instance.attributes['friendly_name'] || entityId;
                ...
                for (const [key, value] of Object.entries(HomeAssistantConstants.ENTITY_SPEAKER_SUPPORTED_FEATURES)) {
                  ...
                  if (supportedFeatures & key) {
                    value.forEach(capabilityId => {
                      homeyDevice.capabilities.push(capabilityId);
                      homeyDevice.capabilitiesOptions[capabilityId] = homeyDevice.capabilitiesOptions[capabilityId] || {};
                      homeyDevice.capabilitiesOptions[capabilityId].title = entity.instance.attributes['friendly_name'] || entityId;
                      homeyDevice.capabilitiesOptions[capabilityId].entityId = entityId;
                    });
                  }
                }
            ...
            if (entityId.startsWith('cover.')) {
              ...
              if (entity.instance.attributes) {
                ...
                if (coveringType === 'garagedoor') {
                  ...
                  homeyDevice.capabilitiesOptions['garagedoor_closed'].title = entity.instance.attributes['friendly_name'] || entityId;
                  homeyDevice.capabilitiesOptions['garagedoor_closed'].entityId = entityId;
                }

                console.log('covering entity', entity.instance);
              }
            }
