    ...
    stateChange(event) {
        try {
            ...
            if (data) {
                ...
                if (deviceIds[2] === 'sensor.lumi_lumi_weather' && !this.compoundcheck) { // compare the device ids to see if there is one id that is shorter than the entities like sensor.gm1813 or sensor.lumi_lumi_weather
