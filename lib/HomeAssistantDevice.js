...
module.exports = class HomeAssistantDevice extends Homey.Device {
  ...
  onInit = async () => {
    ...
    if (this.hasCapability('windowcoverings_state')) {
      this.registerCapabilityListener('windowcoverings_state', (value, options) => {
        switch (value) {
          case 'up':
            this.onCapabilityCoveringService('open_cover', options, 'windowcoverings_state');
            break;
          case 'down':
            this.onCapabilityCoveringService('close_cover', options, 'windowcoverings_state');
            break;
          default:
            this.onCapabilityCoveringService('stop_cover', options, 'windowcoverings_state');
            break;
        }
      });
    }
