...
module.exports = class HomeAssistantDevice extends Homey.Device {
  ...
  onInit = async () => {
    ...
    if (this.hasCapability('speaker_playing')) {
      this.registerCapabilityListener('speaker_playing', this.onCapabilitySpeakerService);
    }
    ...
    if (this.hasCapability('speaker_shuffle')) {
      this.registerCapabilityListener('speaker_shuffle', (value, options) => {
        this.onCapabilitySpeakerService('shuffle_set', options, 'speaker_shuffle');
      });
    }

    if (this.hasCapability('speaker_repeat')) {
      this.registerCapabilityListener('speaker_repeat', (value, options) => {
        this.onCapabilitySpeakerService('repeat_set', options, 'speaker_repeat');
      });
    }
