...
module.exports = class HAUtil {
  ...
  static getClassFromCapabilities(capabilities) {
    ...
    if (capabilities.length > 0) {
      if (capabilities[0].startsWith("measure_")) {
        return 'sensor';
      } else if (capabilities[0].startsWith("speaker_")) {
        return 'speaker';
      } else if (capabilities[0] == 'onoff') {
        return 'light';
      } else {
        return 'other';
      }
    ...
    //     return 'sensor';
    //   } else if (capabilityId.startsWith("speaker_")) {
    //     return 'speaker';
    //   } else if (capabilityId.startsWith("onof")) {
    //     return 'light';
    //   } else {
    //     return 'other';
    //   }
    // })
    // if (capabilities.startsWith("measure_")) {
    //   return 'sensor';
    // } else if (capabilities.startsWith("speaker_")) {
    //   return 'speaker';
    // } else if (capabilities.startsWith("onoff")) {
    //   return 'light';
    // } else {
    //   return 'other';
    // }
