export const ENTITY_SENSOR_CAPABILITY_MAP = {
...
export const ENTITY_MEDIAPLAYER_CLASS_MAP = {
  tv: 'tv',
  speaker: 'speaker',
  receiver: 'amplifier',
};

export const ENTITY_COVER_CLASS_MAP = {
  awning: 'sunshade',
  blind: 'blinds',
  curtain: 'curtain',
...
export const ENTITY_SPEAKER_SUPPORTED_FEATURES = {
...
export const ENTITY_VACUUM_SUPPORTED_FEATURES = {
  // 1: ['onoff'], // Turn On
  // 2: ['onoff'], // Turn Off
  // 4: [''], // Pause
  // 8: [''], // Stop
...
export const ENTITY_FAN_SUPPORTED_FEATURES = {
  1: ['fan_speed'],
  2: ['fan_oscillate'],
  // 4: ['direction'],
  8: ['fan_mode'],
...
export const ENTITY_COVER_SUPPORTED_FEATURES = {
...
export const ENTITY_ALARM_CAPABILITY_MAP = {
  outlet: 'onoff',
